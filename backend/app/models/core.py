...
class School(Base):
    ...
    scholarship_type: Mapped[str] = mapped_column(Text, default="Annual", nullable=False)
...
class Program(Base):
    ...
    name: Mapped[str] = mapped_column(Text, nullable=False)
    program_type: Mapped[str] = mapped_column(Text, default="Annual Grant", nullable=False)
